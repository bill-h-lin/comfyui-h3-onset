...
| bind **both** | **7 of 18** |
| bind **neither**, text to picture + audio in one pass | **4 of 18** |
...
## Constant across all 18 shots, asserted from the files
...
- **`H3ZeroAudioPrefix`**, from [this repo](https://github.com/bill-h-lin/comfyui-h3-onset). Needed for
  10 of the 18 graphs; the other 8 run without it.
- **`PathchSageAttentionKJ`**, from ComfyUI-KJNodes. It is a speed patch. Drop the node and rewire
